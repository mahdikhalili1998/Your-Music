...
const Shortcut: FC<Iheader> = ({ header, open, setOpen, locale }) => {
  return (
    <div
      className={`${locale === "fa" ? "directon-ltr" : null} fixed bottom-3 z-[49] flex px-2 w-full items-center justify-between rounded-lg bg-p-700 p-2 ${!open ? null : "pointer-events-none blur-sm"} `}
    >
