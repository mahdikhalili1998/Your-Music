...
const InstallApp: FC<IInstallApp> = ({
  ...
  return (
    showInstallModal && (
      <div
        className={`${locale === "fa" ? "directon-rtl" : "directon-rtl"} 700:right-28 absolute z-40 flex flex-col items-center justify-center gap-5 rounded-xl bg-gradient-to-r from-p-700 to-p-400 px-10 py-5 500:right-3 550:right-8 600:left-7 600:top-24 sm:right-16 sm:w-max md:right-40 lg:right-72 xl:right-96`}
      >
        <h3
